                            ...
                            <form method="POST" action="{{route('role.update',$role)}}">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" value="{{$role->name}}" name="name" placeholder="input role name" class="form-control">
                                    </div>
                                    <div class="col-sm-6">
...
<style>
    ...
    .tab-border{border: 1px solid #dadada;min-height: 600px;padding-top: 15px;}
    ...
    .tab-content{ float: left;min-height: 600px;width: 100%;}
